...
class AdminController extends Controller
{
    ...
    public function adminAction(int $show, $confirm)
    {
        if ($show >= 0 and $show <= 2) {
            if ($this->session->checkAdmin()) {
                ...
                return $this->render('admin/admin.twig', array('posts' => $posts, 'comments' => $comments, 'show' => $show, 'user' => $user, 'confirm' => $confirm));
            }
        }
    ...
    public function editAction()
    {
        ...
        if (!empty($idy) and $this->session->checkAdmin()) {
            ...
            return $this->render('admin/edit.twig', array('post' => $post));
        }
        return $this->render('home.twig');
    }
